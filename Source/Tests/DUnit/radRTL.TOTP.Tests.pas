...
begin
  ...
  begin
    CheckEquals(EXPECTED_8DIGIT_VALUES[i], TOTP.GeneratePinNumber(SECRET, INPUT_VALUES[i], TOTPLength.EightDigits));
    CheckEquals(EXPECTED_7DIGIT_VALUES[i], TOTP.GeneratePinNumber(SECRET, INPUT_VALUES[i], TOTPLength.SevenDigits));
    CheckEquals(EXPECTED_6DIGIT_VALUES[i], TOTP.GeneratePinNumber(SECRET, INPUT_VALUES[i], TOTPLength.SixDigits));
  end;
end;
